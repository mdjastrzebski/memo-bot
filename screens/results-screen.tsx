    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-900 to-indigo-900 p-4">
      <div className="max-w-md mx-auto space-y-6">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold text-white mb-2">Mission Complete! {getEmoji(percentage)}</h2>
        </div>
              ...
              <div key={index} className="p-4 rounded-lg bg-white/10">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm text-purple-200">Score: {calculateWordScore(word)}</span>
